...
odf2 <- ps %>% 
  ...
  facet_wrap(.~Filière) +
  scale_x_discrete(labels=c("<35","<70","<140","<280",">=280")) +
  ggtitle("Nombre d'admissions par taille des formations")
...
plot_grid(ncol=1, rel_heights = c(1,0.1),
          plot_grid(ncol = 1, 
                    odf1 + theme(legend.position = "none", panel.grid.major.x = element_blank()), 
                    odf2 + theme(legend.position = "none", panel.grid.major.x = element_blank())),
          legend)
```
...
plot_grid(ncol=1, rel_heights = c(1,0.1),
          plot_grid(ncol = 1, 
                    sel1 + theme(legend.position = "none", panel.grid.major.x = element_blank()), 
                    sel2 + theme(legend.position = "none", panel.grid.major.x = element_blank())),
          legend)
```
...
pnp2 <- pnp %>%
  ...
  geom_line() +
  scale_y_continuous(labels = scales::percent, name = "Taux de remplissage") +
  scale_color_brewer(palette = "Dark2") +
